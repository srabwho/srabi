...
os.system('clear') 
import webbrowser
webbrowser.open("https://t.me/SXYPRX")
table = Table(title="SXYPRX",style="RED")
table.add_column("☆ SXYPRX ☆ ",style='green')
table.add_row("PRX",style='RED')
table.add_row(" ",style='RED')
table.add_row("1.   2010 - 2011",style='green')
table.add_row(" ",style='RED')
table.add_row("2.   2012 - 2013",style='green')
table.add_row(" ",style='RED')
table.add_row("3.   2010 - 2019",style='green')
table.add_row(" ",style='RED')
console = Console()
console.print(table)
print(O+' '*20)
